...
router.get("/getAdvisors", verifyTokenAccess, authorizeRoles([RoleEnum.CLIENT, RoleEnum.BANK_ADVISOR, RoleEnum.BANK_MANAGER, RoleEnum.ADMIN]), (req, res) => authController.getAdvisors(req, res))
