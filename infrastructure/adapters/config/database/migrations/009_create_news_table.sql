CREATE TYPE news_category_enum AS ENUM ('FINANCE', 'ECONOMY', 'TECHNOLOGY', 'MARKET', 'REGULATION', 'GENERAL');
CREATE TYPE news_priority_enum AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'URGENT');
