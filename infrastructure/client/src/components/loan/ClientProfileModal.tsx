    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-xl w-full p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={onClose} className="text-gray-500 hover:text-gray-700 text-lg" aria-label="Fermer">
            ✕
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="p-4 rounded-xl border border-gray-100 bg-gray-50">
            ...
            <div className="space-y-2">
              ...
              {history.length === 0 && <p className="text-sm text-gray-600">Aucune demande de crédit pour ce client.</p>}
            </div>
          </div>
        </div>
