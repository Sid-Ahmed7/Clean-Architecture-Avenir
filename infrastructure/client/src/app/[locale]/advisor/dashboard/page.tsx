...
export default function AdvisorDashboard() {
    return (
        <div className="min-h-screen bg-white p-6 mx-auto space-y-8">
            ...
            <section className="mt-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Demandes de crédit</h2>
                <div className="bg-white p-4 rounded-lg shadow flex flex-col gap-3">
                    <p className="text-gray-700">Consultez et traitez les demandes de crédit de vos clients.</p>
            ...
            <section className="mt-6">
                ...
                <div className="bg-white p-4 rounded-lg shadow flex flex-col gap-3">
                    <p className="text-gray-700">Consultez et traitez les demandes d’augmentation de découvert.</p>
