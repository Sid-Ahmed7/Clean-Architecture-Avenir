        ...
        <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 text-white rounded-3xl shadow-2xl border border-blue-800/40 p-8">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              <p className="text-sm text-white/70 uppercase tracking-wide">{t('title')}</p>
              <h1 className="text-3xl md:text-4xl font-bold">Nouvelle actualité</h1>
              <p className="text-sm text-white/80">{t('subtitle')}</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full md:w-auto">
              <div className="bg-white/10 border border-white/20 rounded-2xl px-4 py-3">
                <p className="text-xs uppercase tracking-wide text-white/70">Mise en avant</p>
                <p className="text-lg font-semibold">Landing-like</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-2xl px-4 py-3">
                <p className="text-xs uppercase tracking-wide text-white/70">Rédaction</p>
                <p className="text-lg font-semibold">Guidée & claire</p>
              </div>
            </div>
          </div>
        </div>
