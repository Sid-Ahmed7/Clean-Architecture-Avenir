...
export class MessageEntity {
    public static from(id: number, conversationId: number,conversationClientId: string, conversationAdvisorId: string, authorId: string, content: string, readStatus: ReadStatusEnum, sentAt: Date ) {
        ...
        return new MessageEntity(id, conversationId,validatedClientId.value, validatedAdvisorId.value,validatedAuthorId.value, validatedContent.value, readStatus, sentAt)
    }
        private constructor(
        public id: number,
